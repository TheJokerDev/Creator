...
public enum XSound {
     ...
     */
    @Nullable
    public static CompletableFuture<Record> parse(@Nullable Player player,  Location location, @Nullable String sound, boolean play) {
    ...
    public static class Record {
        ...
        public Record( Sound sound, @Nullable Player player,  Location location, float volume, float pitch, boolean playAtLocation) {
            this.sound = sound;
            this.player = player;
